...
@Entity
public class Cartão implements Serializable{
	...
	public Cartão(Integer id, Integer numero, Date vencimento, String nomeCliente, Integer codigo, String senha,
			Conta conta) {
		super();
		this.id = id;
		this.numero = numero;
